...
console.log(createMenuItem("French Fries" , 2, "Sides"));
console.log(createMenuItem("Wings", 4, "Appetizers"));
console.log(createMenuItem("Chicken Tenders", 12, "Lunch"));
...
console.log(addReview(cloneReviews, 'Sam', 4, 'Worth going just for the atmosphere, food is good, but nothing to write home about.'))
